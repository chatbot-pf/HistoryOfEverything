...
> Development workflow conventions for The History of Everything.
> Customized during `/please:setup`. Referenced by `/please:implement`.
...
- Verify animation controller behavior
...
- Test search and favorites functionality
